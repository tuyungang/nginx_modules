...
#include "ngx_stream_myupstream.h"
...
ngx_stream_upstream_srv_conf_t *ngx_stream_myupstream_add(ngx_conf_t *cf,
    ngx_url_t *u, ngx_uint_t flags);

static ngx_command_t  ngx_stream_myupstream_commands[] = {
...
static ngx_stream_module_t  ngx_stream_myupstream_module_ctx = {
...
ngx_module_t  ngx_stream_myupstream_module = {
    NGX_MODULE_V1,
    &ngx_stream_myupstream_module_ctx,       /* module context */
    ngx_stream_myupstream_commands,          /* module directives */
...
ngx_stream_upstream(ngx_conf_t *cf, ngx_command_t *cmd, void *dummy)
{
    ...
    uscf = ngx_stream_myupstream_add(cf, &u, NGX_STREAM_UPSTREAM_CREATE
    ...
    ctx->srv_conf[ngx_stream_myupstream_module.ctx_index] = uscf;
...
ngx_stream_myupstream_add(ngx_conf_t *cf, ngx_url_t *u, ngx_uint_t flags)
{
    ngx_uint_t                        i;
    ngx_stream_upstream_server_t     *us;
    ...
    umcf = ngx_stream_conf_get_module_main_conf(cf, ngx_stream_myupstream_module);
