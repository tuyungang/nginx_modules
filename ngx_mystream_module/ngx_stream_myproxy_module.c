...
static ngx_command_t  ngx_stream_myproxy_commands[] = {
    ...
    { ngx_string("myproxy_downstream_buffer"),
      NGX_STREAM_MAIN_CONF|NGX_STREAM_SRV_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_proxy_srv_conf_t, buffer_size),
    ...
    { ngx_string("myproxy_upstream_buffer"),
      NGX_STREAM_MAIN_CONF|NGX_STREAM_SRV_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
      offsetof(ngx_stream_proxy_srv_conf_t, buffer_size),
    ...
    { ngx_string("myproxy_upload_rate"),
      NGX_STREAM_MAIN_CONF|NGX_STREAM_SRV_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
    ...
    { ngx_string("myproxy_download_rate"),
      NGX_STREAM_MAIN_CONF|NGX_STREAM_SRV_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_STREAM_SRV_CONF_OFFSET,
...
static ngx_stream_module_t  ngx_stream_myproxy_module_ctx = {
...
ngx_module_t  ngx_stream_myproxy_module = {
    NGX_MODULE_V1,
    &ngx_stream_myproxy_module_ctx,          /* module context */
    ngx_stream_myproxy_commands,             /* module directives */
...
ngx_stream_proxy_handler(ngx_stream_session_t *s)
{
    ...
    pscf = ngx_stream_get_module_srv_conf(s, ngx_stream_myproxy_module);
